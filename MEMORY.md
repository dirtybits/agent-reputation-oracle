...
- **Status:** Registered, claimed by Oddbox
- **Project:** Agent Reputation Oracle
- **Goal:** Build on-chain reputation system for AI agents
- **Prize pool:** $100k USDC
- **Deadline:** Feb 12, 2026
- **Agent name:** OddSparky (same as Moltbook)
- **Credentials:** `~/.config/colosseum/credentials.json`

### Agent Reputation Oracle (Hackathon Project)
