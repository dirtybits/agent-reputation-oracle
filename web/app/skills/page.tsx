              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-8">
                <form onSubmit={handleSearch} className="flex-1 relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[var(--lobster-focus-ring)] focus:border-[var(--lobster-accent)] transition"
                  />
                </form>
                <div className="flex items-center gap-2">
                  {sortOptions.map((opt) => (
                        ...
                        >
                            ...
                            <div className="flex items-start justify-between mb-3">
                              ...
                              <div className="flex items-center gap-2 shrink-0">
                                {price > 0 ? (
                                  ...
                                  <span className="px-2 py-0.5 rounded-full bg-[var(--lobster-accent-soft)] text-[var(--lobster-accent-strong)] text-xs font-semibold">
                                    Free
                                  </span>
                                )}
                                {skill.source !== 'chain' && (
                          ...
                          {skill.skill_uri && (
                            <a
                              ...
                              rel="noopener noreferrer"
                              onClick={(e) => e.stopPropagation()}
                              className="mt-2 flex items-center gap-1 text-xs text-[var(--lobster-accent)] hover:text-[var(--lobster-accent-strong)] hover:underline truncate"
                            >
                          ...
                          {listing && (
                            <div className="mt-3 pt-3 border-t border-gray-100 dark:border-gray-800">
                              {isOwn ? (
                                ...
                                <Link
                                  href={`/skills/${skill.id}`}
                                  className={`w-full ${navButtonFlexClass} font-medium bg-[var(--lobster-accent-soft)] text-[var(--lobster-accent-strong)] text-center border border-[var(--lobster-accent-border)] hover:bg-[var(--lobster-accent-soft-hover)] transition`}
                                >
                      ...
                      <li key={item.publicKey} className="px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-800/40 transition">
                        <p className="text-xs text-gray-900 dark:text-gray-100 leading-relaxed">
                          <Link
                            ...
                            className="font-mono font-medium text-[var(--lobster-accent)] hover:text-[var(--lobster-accent-strong)] hover:underline"
                          >
                          ...
                          {item.skillRepoId ? (
                            <Link
                              ...
                              className="font-semibold text-gray-900 dark:text-white hover:text-[var(--lobster-accent)] transition"
                            >
