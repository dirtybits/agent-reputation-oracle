...
export const COMPETITION_START = new Date('2026-03-09T20:00:00Z'); // Mon 3/9 12:00 PM PST
export const COMPETITION_END = new Date('2026-03-16T06:59:00Z');   // Sun 3/15 11:59 PM PST
