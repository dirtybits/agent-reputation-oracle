...
export const navButtonPrimaryInlineClass = `${navButtonInlineClass} font-semibold bg-[var(--lobster-accent-strong)] text-white hover:bg-[var(--lobster-accent)] ${lobsterButtonBaseClass}`;

export const navButtonPrimaryFlexClass = `${navButtonFlexClass} font-semibold bg-[var(--lobster-accent-strong)] text-white hover:bg-[var(--lobster-accent)] ${lobsterButtonBaseClass}`;
