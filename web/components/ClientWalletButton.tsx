...
function ClientWalletButtonWithPhantom() {
  ...
  const socialSection = (
    <div className="px-4 py-2.5 border-b border-gray-100 dark:border-gray-800">
      <p className="text-xs font-semibold text-gray-700 dark:text-gray-300 mb-2">Sign in with</p>
      <div className="phantom-connect-wrapper"><ConnectButton /></div>
    </div>
  );

  return <WalletDropdown connectors={connectors} connect={connect} showMenu={showMenu} setShowMenu={setShowMenu} menuRef={menuRef} socialSection={socialSection} />;
}
